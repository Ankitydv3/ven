...
export function LoginForm({ role, demoHint, redirectTo }: { role: "admin" | "team"; demoHint: string; redirectTo: string }) {
  ...
  return (
    <div className="relative flex min-h-screen items-center justify-center overflow-hidden bg-gradient-to-br from-slate-50 via-white to-[#EAF5F2] px-4 py-12 dark:from-[#04120F] dark:via-[#06160F] dark:to-[#0A1F1A] sm:px-6">
      {/* Ambient glow */}
