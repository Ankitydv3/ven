...
export const accentTextClass = "text-[#2F6B63] dark:bg-app";

export const inputClass =
  "h-11 rounded-xl border-slate-200 bg-white text-slate-900 placeholder:text-slate-400 focus-visible:border-[#4F9B8C] focus-visible:ring-[#4F9B8C]/20 dark:border-white/[0.08] dark:bg-app/60 dark:text-white dark:placeholder:text-white/40";
