...
router.get("/client-history", auth_1.authRequired, (0, asyncHandler_1.asyncHandler)(complaintController_1.getClientHistory));
router.get("/client-history/:complaintId/detail", auth_1.authRequired, (0, asyncHandler_1.asyncHandler)(complaintController_1.getClientHistoryComplaintDetail));
...
router.patch("/:id/revisit", auth_1.authRequired, (0, auth_1.requireAdminPortalRole)(), (0, asyncHandler_1.asyncHandler)(complaintController_1.scheduleRevisit));
